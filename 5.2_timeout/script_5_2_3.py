'''
https://stepik.org/lesson/2012895/step/3?unit=2041134

Мы создадим одну корутину slow_operation(delay), которая просто "спит" заданное количество секунд. Затем мы вызовем ее дважды с разными тайм-аутами.
'''
