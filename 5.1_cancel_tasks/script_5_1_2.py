'''
https://stepik.org/lesson/2012893/step/2?unit=2041132

get_user_data(): Эта корутина будет имитировать запрос к базе данных или API. В нашем примере она будет "падать", вызывая исключение ValueError, как будто пользователь с таким ID не найден.

main(): Эта корутина будет вызывать get_user_data() и обрабатывать возможную ошибку с помощью try...except.
'''
